...
#include "../Wifibot/cqtopencvviewergl.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CQtOpenCVViewerGl_t, stringdata) + ofs \
...
void *CQtOpenCVViewerGl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CQtOpenCVViewerGl.stringdata))
